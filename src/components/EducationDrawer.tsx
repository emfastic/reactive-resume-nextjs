...
export default function EducationDrawer({
  ...
  function handleSubmit(values: EducationExperience) {
    if (isEdit) {
      ...
      updateKeyedObjectSection([values], "education");
      successToast({
                ...
                <Stack spacing="6px">
                  <Box>
                    <Field name="school">
                      {({ field, form }: any) => (
                        <FormControl
                          isInvalid={form.errors.school && form.submitCount > 0}
                        >
                  ...
                  <Box>
                    <Field name="degreeType">
                      {({ field, form }: any) => (
                        <FormControl
                          isInvalid={
                            form.errors.degreeType && form.submitCount > 0
                          }
                        >
                          <FormLabel htmlFor="degree-type">
                            Degree Type
                          </FormLabel>
                          <Select
                            {...field}
                  ...
                  <Box>
                    <Field name="gradDate">
                      {({ field, form }: any) => (
                        <FormControl
                          isInvalid={
                            form.errors.gradDate && form.submitCount > 0
                          }
                        >
                          <FormLabel htmlFor="grad-date">
                            Graduation Date
                          </FormLabel>
                          <DatePicker
                  ...
                  <Box>
                    <Field name="major">
                      {({ field, form }: any) => (
                        <FormControl
                          isInvalid={form.errors.major && form.submitCount > 0}
                        >
                          <FormLabel htmlFor="major">Major</FormLabel>
                          <Input {...field} id="major" placeholder="Major" />
                          <FormHelperText>
                            Put undeclared if you are undecided.
                          </FormHelperText>
                          <FormErrorMessage>
                            {form.errors.major}
                          </FormErrorMessage>
                    ...
                    <Field name="minor">
                      {({ field, form }: any) => (
                        <FormControl>
                          ...
                          <Input {...field} id="minor" placeholder="Minor" />
                        </FormControl>
                      )}
                    </Field>
                  </Box>
                    ...
                    <Field name="gpa">
                      {({ field, form }: any) => (
                        <FormControl>
                          ...
                          <FormHelperText>
                            Leave as 0.00 if you do not want to share.
                          </FormHelperText>
                        </FormControl>
                      )}
                    </Field>
